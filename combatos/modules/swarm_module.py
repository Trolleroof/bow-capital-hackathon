"""Swarm module — bridges the existing swarm/bus.py server to the main CombatOS bus.
...
See combatos/HOOK_SWARM.md for the Phase 3 upgrade (direct publishing to :8000).
"""
