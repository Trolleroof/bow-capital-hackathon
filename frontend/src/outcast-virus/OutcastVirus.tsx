...
import { useOutcastVirusState } from './useOutcastVirusState'
...
import './outcast-virus.css'

type View = 'boot' | 'command' | 'optic'

export function OutcastVirus() {
  const { t, log, followTarget, confirmTarget, releaseTarget } = useOutcastVirusState()
