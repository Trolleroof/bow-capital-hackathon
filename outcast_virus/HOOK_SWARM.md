# HOOK_SWARM.md — How swarm (⓸) connects to the Outcast Virus orchestrator
...
```bash
SWARM_BUS_URL="" python -m outcast_virus   # disables relay; swarm connects directly
```
...
# Terminal 2:
cd <repo-root> && uv run --project outcast_virus python -m outcast_virus
