"""Outcast Virus WebSocket bus server.
...
Run:
    python -m outcast_virus.orchestrator   (preferred — starts everything)
    python -m outcast_virus.bus.ws_server  (bus only, for testing)
"""
...
async def serve() -> None:
    ...
    async with websockets.serve(
        ...
        log.info(
            "Outcast Virus bus  ws://%s:%d  (dashboard + remote modules connect here)",
