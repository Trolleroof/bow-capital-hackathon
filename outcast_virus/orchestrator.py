"""Outcast Virus orchestrator entrypoint.
...
async def main() -> None:
    ...
    if config.ENABLE_SWARM:
        ...
        log.info("[swarm] disabled; set OUTCAST_VIRUS_SWARM=1 to enable swarm relay")
    ...
    log.info("=== Outcast Virus Orchestrator stopped ===")
