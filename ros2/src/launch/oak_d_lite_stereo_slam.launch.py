...
def launch_setup(context, *args, **kwargs):
    ...
    enable_outcast_virus_bridge = LaunchConfiguration("enable_outcast_virus_bridge", default="false")
    ...
    return [
        ...
        Node(
            package="outcast_virus_slam_bridge",
            executable="slam_bridge",
            name="outcast_virus_slam_bridge",
            namespace=namespace,
            condition=IfCondition(enable_outcast_virus_bridge),
            parameters=[{
                "orch_ws": orch_ws,
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("enable_outcast_virus_bridge", default_value="false"),
