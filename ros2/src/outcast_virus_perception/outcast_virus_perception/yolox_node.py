...
class YoloXNode(Node):
    def __init__(self) -> None:
        super().__init__("outcast_virus_yolox_node")
        ...
        self.declare_parameter("model_type", os.getenv("OUTCAST_VIRUS_YOLO_MODEL_TYPE", "ultralytics"))
        self.declare_parameter("model_path", os.getenv("OUTCAST_VIRUS_YOLO_MODEL", "perception/yolo11n.pt"))
        self.declare_parameter("yolox_exp_file", os.getenv("OUTCAST_VIRUS_YOLOX_EXP", ""))
        self.declare_parameter("device", os.getenv("OUTCAST_VIRUS_YOLO_DEVICE", "0"))
        self.declare_parameter("confidence", float(os.getenv("OUTCAST_VIRUS_YOLO_CONF", "0.40")))
        self.declare_parameter("iou", float(os.getenv("OUTCAST_VIRUS_YOLO_IOU", "0.45")))
        self.declare_parameter("fp16", os.getenv("OUTCAST_VIRUS_YOLO_FP16", "1") == "1")
        self.declare_parameter("publish_annotated", True)
        self.declare_parameter("max_fps", float(os.getenv("OUTCAST_VIRUS_YOLO_MAX_FPS", "15.0")))
    ...
    def _on_image(self, msg: Image) -> None:
        ...
        payload: dict[str, Any] = {
            "schema": "outcast_virus.perception.v1",
            "seq": self.seq,
